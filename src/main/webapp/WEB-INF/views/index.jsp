...
<head>
    ...
    <script src="https://kit.fontawesome.com/78a9b36e55.js"></script>
    <style>
        body {
...
<div id="myCarousel" class="carousel slide content" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="<c:url value='/images/1.png'/>" class="d-block w-100" alt="Image 1">
        </div>
        <div class="carousel-item">
            <img src="<c:url value='/images/2.png'/>" class="d-block w-100" alt="Image 2">
        </div>
        <div class="carousel-item">
            <img src="<c:url value='/images/3.png'/>" class="d-block w-100" alt="Image 3">
        </div>
    </div>
