...
import com.rjgc.xxx.investtrackpro.service.UserService;
...
public class UserController extends HttpServlet {
    ...
    private void registerUser(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (SecurityUtil.isInvalid(username) || SecurityUtil.isInvalid(password) || SecurityUtil.isInvalid(email)) {
    ...
    private void loginUser(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // 检查邮箱或密码是否为空
        if (SecurityUtil.isInvalid(email) || SecurityUtil.isInvalid(password)) {
